...
import com.alexandru.developer.aplicatie_studenti.storage.DBAdapter;
...
public class SearchableActivity extends FragmentActivity {//extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(course == null){
            ...
            AbsPres absPres = getResults(name, type, info);
            DBAdapter dbAdapter = new DBAdapter(this);
            dbAdapter.open();
    ...
    private AbsPres getResults(String name, String type, String info){
        ...
        if(info.equals(ViewPagerAdapter.COURSES_IN_EVEN_WEEK)){
            for(i = 2; i <= MyActivity.WEEKS_IN_SEMESTER; i+=2){
                ...
                if(this.getSharedPreferences(NonCurrentWeekActivity.PARTIAL_NAME_BACKUP_FILE + i, MODE_PRIVATE).
